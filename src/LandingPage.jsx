export default function GnJRepsLandingPage() {
  // Use the logo from the public folder. When running in a Vite
  // application the public directory is served at the root. This ensures
  // the image path works both in development and in the deployed
  // environment on Vercel.
  const logoSrc = "/gnj-logo.png";

  return (
    <div className="min-h-screen bg-white text-slate-900">
      {/* Header with brand and call‑to‑action */}
